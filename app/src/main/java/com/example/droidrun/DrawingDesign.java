 ...
 */
public class DrawingDesign extends View {
    ...
    // original size of DrawingDesign
    public int WIDTH;
    public int HEIGHT;
    ...
    public DrawingDesign(Context context) {
        this(context, null);
    }

    public DrawingDesign(Context context, AttributeSet attrs) {
        super(context, attrs);
        mPaint = new Paint();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (FingerPath fp : paths) {
            ...
            mPaint.setStrokeWidth(fp.inkWidth);
    ...
    public Bitmap getNormalizedBitmap() {
        float scaleFactor = DoodleImgClassifier.DIM_IMG_SIZE_HEIGHT / (float) mBitmap.getHeight();
